							...
							<div class="panel-body">
								<table id="zctb" class="table table-bordered " cellspacing="0" width="100%">
									...
									<tbody>
										<?php
										$aid = $_SESSION['login'];
										$ret = "SELECT registration.*, halls.hall_name, blocks.block_type, blocks.block_name 
												FROM registration 
												LEFT JOIN halls ON registration.hall_id = halls.id
												LEFT JOIN blocks ON registration.block_id = blocks.id
												WHERE emailid = ?";
